...
// [SECTION] Style TextEditor / ShowStyleEditor()
// [SECTION] User Guide / ShowUserGuide()
// [SECTION] Example App: Main Menu Bar / ShowExampleAppMainMenuBar()
// [SECTION] Example App: Debug Console / ShowExampleAppConsole()
// [SECTION] Example App: Debug Log / ShowExampleAppLog()
// [SECTION] Example App: Simple Layout / ShowExampleAppLayout()
// [SECTION] Example App: Property TextEditor / ShowExampleAppPropertyEditor()
...
// Play it nice with Windows users (Pulse: May 2018, Notepad now supports Unix-style carriage returns!)
#ifdef _WIN32
#define IM_NEWLINE  "\r\n"
#else
#define IM_NEWLINE  "\n"
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    {
        ImGui::Begin("Dear ImGui Style TextEditor", &show_app_style_editor);
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Tools"))
        {
            ...
            ImGui::MenuItem("Style TextEditor", NULL, &show_app_style_editor);
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("The \"Tools\" menu above gives access to: About Box, Style TextEditor,\n"
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        {
            HelpMarker("The same contents can be accessed in 'Tools->Style TextEditor' or by calling the ShowStyleEditor() function.");
            ImGui::ShowStyleEditor();
            ImGui::TreePop();
            ImGui::Separator();
        }
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        // Pulse item list if we changed the number of items
        static ImVector<MyItem> items;
...
{
    IMGUI_DEMO_MARKER("Tools/Style TextEditor");
...
static void ShowExampleAppPropertyEditor(bool* p_open)
{
    ...
    IMGUI_DEMO_MARKER("Examples/Property TextEditor");
